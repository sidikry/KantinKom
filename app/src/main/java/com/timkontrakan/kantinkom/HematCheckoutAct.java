...
public class HematCheckoutAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hemat_checkout);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                nama_item.setText(dataSnapshot.child("nama_hemat").getValue().toString());
            ...
            public void onClick(View view) {
                ...
                reference3.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        reference3.getRef().child("nama_drink").setValue(nama_item.getText().toString());
                        ...
                        //Fungsi Intent
                        Intent gotosucces = new Intent(HematCheckoutAct.this, SuccesBuyFoodAct.class);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent gotohome = new Intent(HematCheckoutAct.this, HematAct.class);
